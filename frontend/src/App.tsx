                ...
                <div className="chart-stage" ref={chartStageRef} onMouseLeave={clearPredictionMarkerHover}>
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={chartData} margin={{ top: 16, right: 18, bottom: 8, left: 8 }}>
                      <CartesianGrid stroke="rgba(92, 79, 65, 0.14)" vertical={false} />
                      <XAxis dataKey="date" tick={{ fill: "#756a5d", fontSize: 12 }} tickMargin={12} minTickGap={36} />
                      <YAxis
                        tick={{ fill: "#756a5d", fontSize: 12 }}
